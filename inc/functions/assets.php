...
/**
    ...
    function myselfbks_scripts(){
        ...
        wp_enqueue_style('myselfbks-st',get_template_directory_uri().'/style.css',array(),'4.15','all');
        wp_enqueue_style('myselfbks-ani',get_template_directory_uri().'/assets/css/plugins/animate.css',array(),'1.0','all');
